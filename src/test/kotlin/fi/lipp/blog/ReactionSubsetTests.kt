...
class ReactionSubsetTests : UnitTestBase() {
    ...
    fun setUp() {
        ...
        transaction {
            reactionService.createReaction(user1Id, "like", FileUploadData("like.png", avatarFile1.inputStream()))
            reactionService.createReaction(user1Id, "love", FileUploadData("love.png", avatarFile1.inputStream()))
            reactionService.createReaction(user1Id, "haha", FileUploadData("haha.png", avatarFile1.inputStream()))
        }
    }
